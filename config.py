...
def arg():
    ...
    parser.add_argument(
        ...
        help="Please do not enter any value.",
    )
    parser.add_argument(
        "--time",
    ...
    # Mode
    parser.add_argument(
        "--mode", default="train", choices=["test", "debug"]
    )  # NOTE: test 코드 만들어야 함.
    parser.add_argument(
        "--pretrained_path", help="example: ./result/bcic4_2a/test/1/checkpoint/200.tar"
    )
    parser.add_argument(
        "--train_cont_path", help="example: ./result/bcic4_2a/test/1/checkpoint/200.tar"
    )
    parser.add_argument(
        "--paradigm", default="session", choices=["ind"], help="Please enter ind or not"
    )
    ...
    parser.add_argument(
        "--train_subject", default=1, help="Please do not enter any value."
    )
    ...
    parser.add_argument(
        ...
        type=band_list,
        default=[[0, 42]],
        help="Please connect it with a comma.",
    )
    parser.add_argument(
        "--chans", default="all", type=str2list, help="Please connect it with a comma."
    )
    parser.add_argument(
        "--labels",
        default="all",
    ...
    # Train
    parser.add_argument(
        "--criterion", default="CEE", help="Please enter loss function you want to use."
    )
    parser.add_argument(
        "--opt", default="Adam", help="Please enter optimizer you want to use."
    )
    parser.add_argument(
        "--metrics",
        default="loss,acc",
    ...
    parser.add_argument(
        "--print_step", default=5, type=int, help="Number of print results per epoch."
    )
